...
@RestController
@RequestMapping("/api/project-base-app-kafka")
public class ProjectBaseAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ProjectBaseAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ProjectBaseAppKafkaResource(KafkaProperties kafkaProperties) {
